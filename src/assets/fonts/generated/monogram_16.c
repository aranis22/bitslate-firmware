 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font src/assets/fonts/monogram.ttf --range 32-126 --size 16 --bpp 1 --format lvgl --force-fast-kern-format -o src/assets/fonts/generated/monogram_16.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t monogram_16 = {
#else
lv_font_t monogram_16 = {
#endif

...
float SpringMassModel::getMassKg() const {
  return massKg;
}

float SpringMassModel::getSpringK() const {
  return springK;
}

float SpringMassModel::getDamping() const {
  return damping;
}

float SpringMassModel::getGravity() const {
  return gravity;
}

float SpringMassModel::getRestLength() const {
  return restLength;
}

float SpringMassModel::getDisplacement() const {
  return displacement;
}

float SpringMassModel::getVelocity() const {
  return velocity;
}
...
float SpringMassModel::getSpringForce() const {
  return -springK * displacement;
}

float SpringMassModel::getGravityForce() const {
  return massKg * gravity;
}

float SpringMassModel::getDampingForce() const {
...
bool SpringMassModel::isDragging() const {
  return dragging;
}

bool SpringMassModel::isPlaying() const {
  return playing;
}
